...
public class NetworkStatusManager {
    ...
    private class ConnectivityBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (DBG) {
                Log.d(TAG, String.format("onReceive(): mNetworkInfo=%s mOtherNetworkInfo = %s mState=%s", mNetworkInfo, mOtherNetworkInfo == null ? "[none]" : mOtherNetworkInfo + " noConn=" + noConnectivity, mState.toString()));
            }
