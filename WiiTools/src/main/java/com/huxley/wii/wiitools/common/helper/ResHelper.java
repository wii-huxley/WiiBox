...
public class ResHelper {
    ...
    private static Resources getResources() {
        if (resources == null) {
            resources = WiiApplication.getContext().getResources();
        }
        return resources;
    }
    ...
    public static int getColor (@ColorRes int colorResId) {
        return ContextCompat.getColor(WiiApplication.getContext(), colorResId);
    }
    ...
    public static Drawable getDrawable(@DrawableRes int drawableResId) {
        return ContextCompat.getDrawable(WiiApplication.getContext(), drawableResId);
    }
