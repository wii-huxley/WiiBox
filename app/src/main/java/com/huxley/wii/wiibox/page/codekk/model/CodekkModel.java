package com.huxley.wii.wiibox.page.codekk.model;
...
public class CodekkModel {
    ...
    public Observable<ResultBean<CodekkProjectBean>> getDetailInfo(String id) {
        return HttpClient.getCodekkApi().getDetailInfo(id)
                .subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
    }
