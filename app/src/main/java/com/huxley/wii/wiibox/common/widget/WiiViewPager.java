...
public class WiiViewPager extends ViewGroup{
	...
	public WiiViewPager(Context context) {
		this(context, null);
	}

	public WiiViewPager(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public WiiViewPager(Context context, AttributeSet attrs, int defStyleAttr) {
...
//			view.getScreenWidth();  得到view的真实的大小。
		}
...
//		scrollTo(currId*getWidth(), 0);
		...
		if(pageChangedListener!=null){
			pageChangedListener.onPageSelected(currId);
		}
